    ...
    <ul class="user-list">
        <li v-for="player in player_scores" class="user">
            ...
            <p class="points">
                ...
                /
                <span class="game-points">{{ player.game_points }}</span>
            </p>
        </li>
    </ul>
</template>
...
.user-list{
    ...
    & .user{
        display: grid;
        align-items: center;
        grid-template-columns: var(--_icon-size) min-content min-content;
        gap: 1rem;
        ...
        border-radius: var(--_icon-size) 0 0 var(--_icon-size);
